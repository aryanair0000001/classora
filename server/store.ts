...
const defaultData: DatabaseSchema = {
  profile: {
    ...
    enrolledClassIds: ['cohort-cu-cse4-a', 'cohort-stan-cs301'],
    university: 'Chandigarh University'
  },
  universities: [
    { id: 'univ-cu', name: 'Chandigarh University', country: 'India', campus: 'Gharuan Main Campus' },
    { id: 'univ-iitd', name: 'Indian Institute of Technology (IIT) Delhi', country: 'India', campus: 'Hauz Khas' },
    { id: 'univ-stanford', name: 'Stanford University', country: 'United States', campus: 'Main Quad' },
    { id: 'univ-mit', name: 'Massachusetts Institute of Technology (MIT)', country: 'United States', campus: 'Cambridge' },
    { id: 'univ-du', name: 'Delhi University', country: 'India', campus: 'North Campus' }
  ],
  classes: [
    {
      id: 'cohort-cu-cse4-a',
      code: 'CU-24CSE-4A',
      name: 'B.Tech CSE - 4th Semester (Section A)',
      universityId: 'univ-cu',
      universityName: 'Chandigarh University',
      program: 'Bachelor of Engineering / B.Tech',
      branch: 'Computer Science & Engineering',
      semester: 'Semester 4',
      section: 'Section A (CSE-4A)',
      academicYear: '2025-2026',
      totalStudents: 74,
      crName: 'Aryan Nair (Class Representative)',
  ...
  members: {
    'cohort-cu-cse4-a': [
      ...
      { id: 'mem-2', name: 'Dr. Rajiv Kumar', email: 'rajiv.cse@cumail.in', role: 'FACULTY', joinedAt: '2026-01-10' },
  ...
  assignments: [
    {
      ...
      dueDateISO: new Date(Date.now() + 6 * 3600 * 1000).toISOString(),
      relativeTime: 'Due in 6 hours',
      isCompleted: false,
      isPinned: true,
      isVerified: true,
  ...
  notifications: [
    {
      ...
      message: 'Design & Implement B+ Tree Indexing is due in 6 hours (11:59 PM).',
      type: 'reminder',
...
class Store {
  ...
  public getActiveCohort(): ClassCohort {
    const active = this.data.classes.find(c => c.id === this.data.profile.activeClassId);
